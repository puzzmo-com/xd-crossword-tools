  ...
  const editorWillMount = useCallback<EditorWillMount>(
    (m) => {
      ...
      m.editor.defineTheme("puzzmo", {
        ...
        inherit: true,
        rules: [
          { token: "header", foreground: "0d5526", fontStyle: "bold" },
          { token: "across-clue", foreground: "0d5526" },
          { token: "down-clue", foreground: "0d5526" },
          { token: "across-meta", foreground: "134d28" },
          { token: "down-meta", foreground: "134d28" },
        ...
        colors: {
          "editor.foreground": "#1a1f1c",
          "editor.selectionBackground": "#0d552630",
          "editor.lineHighlightBackground": "#f3f5f4",
          "editorCursor.foreground": "#0d5526",
          "editorLineNumber.foreground": "#6b7c72",
          "editorLineNumber.activeForeground": "#0d5526",
        },
      })
    },
